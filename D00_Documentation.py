...
to do:
    ...
    4. to develop mission anti-fail system (optimalization in fail situations) 75%
    5. if time to experiment with multitasking 90%
    6. to develop ultrasonic locator 10%
    7. to create audiovisual manager 75%
