to do:
    1. to clear the code and standartize sintax 90%
    2. to add arm operating function and other 50%
    3. to develop position anti-fail system (accelerometer based) 30%
    4. to develop mission anti-fail system (optimalization in fail situations) 20%
    5. if time to experiment with multitasking 50%
    6. to develop ultrasonic locator 10%
    7. to create audiovisual manager
